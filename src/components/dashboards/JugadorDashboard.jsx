...
function ReferidosTab({ user }) {
  ...
  return (
    <div style={{ maxWidth: 640, margin: '0 auto' }}>
      ...
      {/* Your code */}
      <div style={{ background: 'rgba(15,23,42,0.8)', border: '1px solid #1e293b', borderRadius: 18, padding: '22px 22px', marginBottom: 20 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '16px' }}>
                {gamification.achievements.map((a, i) => (
                  <div key={a.id} style={{
                    ...
                    {!a.unlocked && (
                      <div style={{ fontSize: '1.2rem', color: C.textMuted, flexShrink: 0 }}><i className="bi bi-lock-fill" /></div>
                    )}
                  </div>
                ))}
              </div>
