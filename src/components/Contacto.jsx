      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto', position: 'relative' }}>
        ...
        <div style={{ display: 'flex', gap: '40px', flexWrap: 'wrap', alignItems: 'stretch' }}>
          ...
          <div style={{ flex: '1 1 300px', display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: '30px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '20px' }}>
              <div className="contacto-icon-bg" style={{ width: '54px', height: '54px', borderRadius: '16px', backgroundColor: '#ffffff', border: '1px solid #e2e8f0', display: 'flex', justifyContent: 'center', alignItems: 'center', flexShrink: 0, boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)', color: '#2563eb' }}>
