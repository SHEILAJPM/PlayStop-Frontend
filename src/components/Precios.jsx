...
const Precios = () => (
  <section className="precios-section reveal" id="precios" style={{ scrollMarginTop: '80px', padding: '100px 5%', background: 'linear-gradient(180deg, #030712 0%, #0b1120 50%, #030712 100%)', position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
    ...
    <div style={{ position: 'absolute', top: '-10%', left: '30%', transform: 'translateX(-50%)', width: '600px', height: '600px', background: 'radial-gradient(circle, rgba(0,208,132,0.06) 0%, transparent 70%)', zIndex: 0, pointerEvents: 'none' }}></div>
    ...
    <div style={{ textAlign: 'center', width: '100%', maxWidth: '750px', margin: '0 auto 80px auto', position: 'relative', zIndex: 10 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', marginBottom: '20px' }}>
        ...
        <span style={{ color: '#00d084', fontWeight: '700', fontSize: '0.8rem', letterSpacing: '2.5px', textTransform: 'uppercase' }}>Planes a tu medida</span>
        <div style={{ width: '36px', height: '3px', borderRadius: '2px', background: 'linear-gradient(90deg, #00d084, transparent)' }} />
      </div>
      <h2 className="precios-title" style={{ fontSize: '3.5rem', color: '#f1f5f9', fontWeight: '900', marginBottom: '24px', letterSpacing: '-1.5px', lineHeight: '1.1' }}>Precios <span style={{ background: 'linear-gradient(90deg, #3b82f6, #00d084)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>transparentes</span></h2>
    ...
    <div style={{ display: 'flex', justifyContent: 'center', gap: '30px', flexWrap: 'wrap', position: 'relative', zIndex: 10, alignItems: 'center', width: '100%' }}>
      ...
      <div
        ...
        onMouseOver={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.boxShadow = '0 25px 50px -12px rgba(0,208,132,0.2)'; e.currentTarget.style.borderColor = 'rgba(0,208,132,0.35)'; }}
      ...
      >
        ...
        <button
          ...
          onMouseOver={(e) => { e.currentTarget.style.background = 'rgba(255,255,255,0.14)'; e.currentTarget.style.borderColor = 'rgba(0,208,132,0.4)'; }}
