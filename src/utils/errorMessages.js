export const MESSAGES = {
  LOGIN_ERROR:    'Correo o contrasena incorrectos. Verifica tus datos.',
  REGISTER_ERROR: 'No se pudo completar el registro. Intenta de nuevo.',
  NETWORK_ERROR:  'Sin conexion al servidor. Verifica tu red.',
  SESSION_EXPIRED:'Tu sesion ha expirado. Inicia sesion nuevamente.',
